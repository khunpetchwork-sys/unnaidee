    ...
    >
      ...
      >
        ...
        >
          ...
          <button onClick={onClose} className="absolute top-3 left-3 z-10 w-8 h-8 rounded-full bg-white/90 flex items-center justify-center text-ink text-sm shadow">
            ✕
          </button>

          {gallery.length > 1 && (
            <>
              <button onClick={prev} className="absolute left-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-white/80 rounded-full flex items-center justify-center text-lg shadow z-10">‹</button>
              <button onClick={next} className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-white/80 rounded-full flex items-center justify-center text-lg shadow z-10">›</button>
              ...
              <span className="absolute top-3 right-3 z-10 bg-ink/60 text-white text-[10px] font-mono px-2 py-0.5 rounded-full">
